...
public class Constructor {
    public static void main(String[] args) {
        // FoodItem item1 = new FoodItem("Apple", 50);
        // item1.getFoodItemDetails();
        
        FoodItem[] items = {
            new FoodItem("Apple", 50),
            new FoodItem("Banana", 30),
            new FoodItem("Kiwi", 70),
            new FoodItem("Orange", 20),
            new FoodItem("Stawberry", 80),
            new FoodItem("Mango", 60),
            new FoodItem("Watermelon", 70)
        };

        for (FoodItem foodItem : items) {
            foodItem.getFoodItemDetails();
        }
    }
}
